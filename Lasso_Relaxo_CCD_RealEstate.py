...
data=data_ori[np.abs(stats.zscore(data_ori['Price'])) < 3]  
...
plt.legend( fontsize = 6)   
plt.savefig(path_data+'img2a_re.png') 
plt.close()
#  Histogram of NNZ
...
plt.tight_layout()
plt.savefig(path_data+'img2b_re.png') 
plt.close()
##################Box Plot##########################
...
plt.savefig(path_data+'img2c_re.png') 
plt.figure(figsize = (3,3.2))
...
plt.grid(visible=None)
plt.savefig(path_data+'img2d_re.png') 
plt.close()
...
plt.legend( fontsize = 6)   
plt.savefig(path_data+'img4a_re.png') 
plt.close()
...
plt.legend( fontsize = 6)   
plt.savefig(path_data+'img4b_re.png') 
plt.close()
...
plt.legend( fontsize = 6)   
plt.savefig(path_data+'img5a_re.png') 
plt.close()
...
plt.legend( fontsize = 6)   
plt.savefig(path_data+'img5b_re.png') 
plt.close()
...
plt.legend( fontsize = 6)   
plt.savefig(path_data+'img6a_re.png')
plt.close()
...
plt.legend( fontsize = 6)   
plt.savefig(path_data+'img6b_re.png')
plt.close()
...
plt.legend( fontsize = 6)   
plt.savefig(path_data+'img7a_re.png')
plt.close()
...
plt.legend( fontsize = 6)   
plt.savefig(path_data+'img7b_re.png')
plt.close()
...
plt.legend( fontsize = 6)   
plt.savefig(path_data+'img8a_re.png')
plt.close()
...
plt.legend( fontsize = 6)   
plt.savefig(path_data+'img8b_re.png')
plt.close()
...
#FIGURE 10: Iteration Vs Features Rate
plt.figure(figsize = (6,4))                        
for t in range(n) :
