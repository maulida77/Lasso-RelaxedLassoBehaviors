...
# ##################INPUT##########################
path_data = "Result/realestate/" 
data_ori=pd.DataFrame(pd.read_csv('realestate.csv'))
data=data_ori[np.abs(stats.zscore(data_ori['Price'])) < 3] #remove outlier
# data=data[np.abs(stats.zscore(data['Constructed Area'])) < 3] #remove outlier
# data=data[np.abs(stats.zscore(data['Electrical Power'])) < 3] #remove outlier
features=['Number of Bedrooms','Number of Bathrooms','Number of Parking','Constructed Area','Electrical Power',
'Land Area','Type of Building','Interior','Certificate','Floor','Location']
output=['Price']
featureslabel = ['$X_1$', '$X_2$', '$X_3$', '$X_4$', '$X_5$', '$X_6$', '$X_7$', '$X_8$', '$X_9$', '$X_{10}$', '$X_{11}$']
Coeff = ['$\\beta_1$', '$\\beta_2$', '$\\beta_3$', '$\\beta_4$', '$\\beta_5$', '$\\beta_6$', '$\\beta_7$', '$\\beta_8$', '$\\beta_9$', '$\\beta_{10}$', '$\\beta_{11}$']
X=get_numpy_data(data, features)
X_ori=get_numpy_data(data_ori, features)
y=get_numpy_data(data, output)
y_ori=get_numpy_data(data_ori, output)
...
# fp=['Constructed Area','Electrical Power']
# Xp=get_numpy_data(data, fp)
...
# plt.tight_layout()
# plt.savefig(path_data+'img2_heatmap_re.png') 
# plt.close()
...
# for l in lamda:
#     theta = coordinate_descent_lasso(initial_theta,trainvalid_data_standardized, trainvalid_y_centered,lamda=l, tol=1e-2)
...
# plt.axis('tight')
# plt.savefig(path_data+'img3_re.png')
# plt.close()
...
# # print('[lamda, gamma, CV_MSE, nnz]=', best_cvmse[[0,1,2,3+n]])
...
# plt.xscale('log')
# plt.xlabel('Log($\\lambda$)',fontsize=8)
# plt.ylabel('Coefficients ($\\gamma$=0.5)', fontsize=8)
# plt.legend(fontsize=6)
# plt.tick_params(axis='both',labelsize=8 )
# plt.axis('tight')
# plt.savefig(path_data+'img4_re.png')
# plt.close()
...
# plt.savefig(path_data+'img5_re.png')
# plt.close()
...
#     # print("The Rank of a Matrix: ", np.linalg.matrix_rank(trainvalid_data),np.linalg.matrix_rank(test_data) )
...
# plt.savefig(path_data+'img6_re.png')   
# plt.close()
...
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img7_re.png') 
# plt.close()
...
# plt.tight_layout()
# plt.savefig(path_data+'img8_re.png') 
# plt.close()
...
# plt.savefig(path_data+'img9a_re.png') 
# plt.figure(figsize = (3,3.2))
...
# plt.grid(visible=None)
# plt.savefig(path_data+'img9b_re.png') 
# plt.close()
...
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img10_re.png') 
# plt.close()
...
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img10a_re.png') 
# plt.close()
...
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img10b_re.png') 
# plt.close()
...
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img10c_re.png') 
# plt.close()
...
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img11a_re.png') 
# plt.close()
...
# plt.ylabel('$R^2$',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img11b_re.png') 
# plt.close()
...
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img11c_re.png') 
# plt.close()
...
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img11d_re.png') 
# plt.close()
...
# plt.ylabel('Adjusted $R^2$',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img11e_re.png') 
# plt.close()
...
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img11f_re.png') 
# plt.close()
...
# ###MSE###
# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==6][:,0],keeprelaxo[keeprelaxo[:,5+n]==6][:,n+6], 'o--', color='red',lw=0.5, ms=2, label='MSE_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==6][:,0],keeplasso[keeplasso[:,5+n]==6][:,n+6], 'o--', color='black',lw=0.5, ms=2, label='MSE_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('$MSE$ (nnz=6)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12a1_re.png')
# plt.close()

# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==7][:,0],keeprelaxo[keeprelaxo[:,5+n]==7][:,n+6], 'o--', color='red',lw=0.5, ms=2, label='MSE_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==7][:,0],keeplasso[keeplasso[:,5+n]==7][:,n+6], 'o--', color='black',lw=0.5, ms=2, label='MSE_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('$MSE$ (nnz=7)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12a2_re.png')
# plt.close()

# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==8][:,0],keeprelaxo[keeprelaxo[:,5+n]==8][:,n+6], 'o--', color='red',lw=0.5, ms=2, label='MSE_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==8][:,0],keeplasso[keeplasso[:,5+n]==8][:,n+6], 'o--', color='black',lw=0.5, ms=2, label='MSE_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('$MSE$ (nnz=8)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12a3_re.png')
# plt.close()

# ####PMSE######
# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==6][:,0],keeprelaxo[keeprelaxo[:,5+n]==6][:,n+7], 'o--', color='red',lw=0.5, ms=2, label='PMSE_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==6][:,0],keeplasso[keeplasso[:,5+n]==6][:,n+7], 'o--', color='black',lw=0.5, ms=2, label='PMSE_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('$PMSE$ (nnz=6)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12b1_re.png')
# plt.close()

# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==7][:,0],keeprelaxo[keeprelaxo[:,5+n]==7][:,n+7], 'o--', color='red',lw=0.5, ms=2, label='PMSE_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==7][:,0],keeplasso[keeplasso[:,5+n]==7][:,n+7], 'o--', color='black',lw=0.5, ms=2, label='PMSE_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('$PMSE$ (nnz=7)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12b2_re.png')
# plt.close()

# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==8][:,0],keeprelaxo[keeprelaxo[:,5+n]==8][:,n+7], 'o--', color='red',lw=0.5, ms=2, label='PMSE_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==8][:,0],keeplasso[keeplasso[:,5+n]==8][:,n+7], 'o--', color='black',lw=0.5, ms=2, label='PMSE_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('$PMSE$ (nnz=8)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12b3_re.png')
# plt.close()

# ####R^2 TV######
# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==6][:,0],keeprelaxo[keeprelaxo[:,5+n]==6][:,n+8], 'o--', color='red',lw=0.5, ms=2, label='$R^2$_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==6][:,0],keeplasso[keeplasso[:,5+n]==6][:,n+8], 'o--', color='black',lw=0.5, ms=2, label='$R^2$_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('$R^2$ (nnz=6)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12c1_re.png')
# plt.close()

# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==7][:,0],keeprelaxo[keeprelaxo[:,5+n]==7][:,n+8], 'o--', color='red',lw=0.5, ms=2, label='$R^2$_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==7][:,0],keeplasso[keeplasso[:,5+n]==7][:,n+8], 'o--', color='black',lw=0.5, ms=2, label='$R^2$_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('$R^2$ (nnz=7)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12c2_re.png')
# plt.close()

# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==8][:,0],keeprelaxo[keeprelaxo[:,5+n]==8][:,n+8], 'o--', color='red',lw=0.5, ms=2, label='$R^2$_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==8][:,0],keeplasso[keeplasso[:,5+n]==8][:,n+8], 'o--', color='black',lw=0.5, ms=2, label='$R^2$_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('$R^2$ (nnz=8)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12c3_re.png')
# plt.close()

# ####Adj R^2 TV######
# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==6][:,0],keeprelaxo[keeprelaxo[:,5+n]==6][:,n+10], 'o--', color='red',lw=0.5, ms=2, label='Adj_$R^2$_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==6][:,0],keeplasso[keeplasso[:,5+n]==6][:,n+10], 'o--', color='black',lw=0.5, ms=2, label='Adj_$R^2$_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('Adjusted $R^2$ (nnz=6)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12d1_re.png')
# plt.close()

# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==7][:,0],keeprelaxo[keeprelaxo[:,5+n]==7][:,n+10], 'o--', color='red',lw=0.5, ms=2, label='Adj_$R^2$_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==7][:,0],keeplasso[keeplasso[:,5+n]==7][:,n+10], 'o--', color='black',lw=0.5, ms=2, label='Adj_$R^2$_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('Adjusted $R^2$ (nnz=7)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12d2_re.png')
# plt.close()

# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==8][:,0],keeprelaxo[keeprelaxo[:,5+n]==8][:,n+10], 'o--', color='red',lw=0.5, ms=2, label='Adj_$R^2$_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==8][:,0],keeplasso[keeplasso[:,5+n]==8][:,n+10], 'o--', color='black',lw=0.5, ms=2, label='Adj_$R^2$_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('Adjusted $R^2$ (nnz=8)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12d3_re.png')
# plt.close()

# ####R^2 Test######
# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==6][:,0],keeprelaxo[keeprelaxo[:,5+n]==6][:,n+9], 'o--', color='red',lw=0.5, ms=2, label='$PR^2$_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==6][:,0],keeplasso[keeplasso[:,5+n]==6][:,n+9], 'o--', color='black',lw=0.5, ms=2, label='$PR^2$_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('$PR^2$ (nnz=6)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12e1_re.png')
# plt.close()

# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==7][:,0],keeprelaxo[keeprelaxo[:,5+n]==7][:,n+9], 'o--', color='red',lw=0.5, ms=2, label='$PR^2$_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==7][:,0],keeplasso[keeplasso[:,5+n]==7][:,n+9], 'o--', color='black',lw=0.5, ms=2, label='$PR^2$_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('$PR^2$ (nnz=7)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12e2_re.png')
# plt.close()

# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==8][:,0],keeprelaxo[keeprelaxo[:,5+n]==8][:,n+9], 'o--', color='red',lw=0.5, ms=2, label='$PR^2$_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==8][:,0],keeplasso[keeplasso[:,5+n]==8][:,n+9], 'o--', color='black',lw=0.5, ms=2, label='$PR^2$_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('$PR^2$ (nnz=8)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12e3_re.png')
# plt.close()

# ####Adj R^2 Test######
# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==6][:,0],keeprelaxo[keeprelaxo[:,5+n]==6][:,n+11], 'o--', color='red',lw=0.5, ms=2, label='Adj_$PR^2$_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==6][:,0],keeplasso[keeplasso[:,5+n]==6][:,n+11], 'o--', color='black',lw=0.5, ms=2, label='Adj_$PR^2$_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('Adjusted $PR^2$ (nnz=6)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12f1_re.png')
# plt.close()

# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==7][:,0],keeprelaxo[keeprelaxo[:,5+n]==7][:,n+11], 'o--', color='red',lw=0.5, ms=2, label='Adj_$PR^2$_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==7][:,0],keeplasso[keeplasso[:,5+n]==7][:,n+11], 'o--', color='black',lw=0.5, ms=2, label='Adj_$PR^2$_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('Adjusted $PR^2$ (nnz=7)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12f2_re.png')
# plt.close()

# plt.figure(figsize = (6,4))
# plt.plot(keeprelaxo[keeprelaxo[:,5+n]==8][:,0],keeprelaxo[keeprelaxo[:,5+n]==8][:,n+11], 'o--', color='red',lw=0.5, ms=2, label='Adj_$PR^2$_Relaxo')
# plt.plot(keeplasso[keeplasso[:,5+n]==8][:,0],keeplasso[keeplasso[:,5+n]==8][:,n+11], 'o--', color='black',lw=0.5, ms=2, label='Adj_$PR^2$_Lasso')
# plt.tick_params(axis='both',labelsize=6)  
# plt.xlabel('Iteration', fontsize=8)
# plt.ylabel('Adjusted $PR^2$ (nnz=8)',fontsize=8)
# plt.legend( fontsize = 6)   
# plt.savefig(path_data+'img12f3_re.png')
# plt.close()
...
print('FULL DATA')
Xs, std = normalize_features(X_ori)
yc = centered_output(y_ori)
lamda=1
gama=0.5
tol=1e-12
...
pred_train_lasso= model2.predict(Xs)
print(mean_squared_error(yc,pred_train_lasso))

theta_lasso=coordinate_descent_lasso(initial_theta,Xs, yc,lamda, tol)
print('theta lasso:',theta_lasso)
print('theta lasso ori:',theta_lasso/std)
y_pred = np.dot(Xs,theta_lasso).reshape(-1,1)
mse1=get_MSE(yc, y_pred)
print('mse:', mse1)


theta_LSf=theta_LS_full (theta_lasso, Xs, yc)
